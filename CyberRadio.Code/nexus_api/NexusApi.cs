...
/// <summary>
///     Provides a static class for interacting with the Nexus API; a high-level wrapper around
///     <see cref="Pathoschild.FluentNexus.NexusClient" />.
///     <para>
///         This class maintains a single API user, <see cref="CurrentApiUser" /> and a reference to the underlying
///         <see cref="Pathoschild.FluentNexus.NexusClient" />.
///     </para>
/// </summary>
public static class NexusApi
{
    ...
    /// <returns>
    ///     A task, that when completed, contains the mod's main image or the default missing image if the mod did not
    ///     have an image.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     A task, that when completed, contains the user's profile image or the default profile image if the user did
    ///     not have an image.
    /// </returns>
